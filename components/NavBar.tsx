							...
							{pages.map((page) => (
								<MenuItem key={page} onClick={handleCloseNavMenu}>
									...
									<Button
										...
										sx={{ my: 2, color: '#808080', display: 'block', fontFamily: 'Archivo Narrow'}}//, textTransform: 'none' }}
									>
										{page}
									</Button>
								</MenuItem>
					...
					<Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
						{pages.map((page) => (
							<Button
								...
								href={`/${page == 'Home' ? '' : page}`}
								onClick={handleCloseNavMenu}
								sx={{ my: 2, color: trigger? '#a0a0a0' : '#303030', display: 'block', fontFamily: 'Archivo Narrow'}}//, textTransform: 'none' }}
							>
								{page}
							</Button>
						))}
